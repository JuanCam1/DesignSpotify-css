    ...
    <footer className='barra'>
      <div className='barra-cont'>
        <div className='barra-info'>
          <img
            src='https://i.scdn.co/image/ab67616d00004851a5585d5d7b86366971d77fd7'
            alt='img'
          />
          <div className='barra-title'>
            <p>To make you feel my love</p>
            <p>Jules and the Gang</p>
          </div>
          ...
          <div className='container-svg'>
            <svg role='img' height='16' width='16' viewBox='0 0 16 16'>
              ...
              ></path>
              <path fill='currentColor' d='M12 8.75H4v-1.5h8v1.5z'></path>
            </svg>
          </div>
        </div>

        <div className='barra-options'>
          <div className='barra-state'>
            <div className='container-svg'>
              <svg role='img' height='16' width='16' viewBox='0 0 16 16'>
                <path
                  fill='currentColor'
